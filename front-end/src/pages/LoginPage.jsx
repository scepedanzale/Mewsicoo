      ...
      <form onSubmit={handleLogin} className='px-2 sm:px-20 md:px-40 lg:px-64 xl:px-96'>
        ...
        <div className="mb-4">
          ...
          <div className='w-full flex justify-between'>
            ...
            <Link>
              <span className='text-[#339a9a] hover:text-[#2e8b8b] text-sm'>Hai dimenticato la password?</span> 
            </Link>
          </div>
        </div>
        <div className="mt-10 w-full flex justify-center">
            <button type='submit' className='bg-[#339a9a] text-neutral-100 p-2 rounded-md w-1/2 hover:bg-[#2e8b8b]'>Accedi</button>
        </div>
      </form>
      <div className='text-lg mt-8 text-gray-500 mx-auto max-w-max'>
          Non sei ancora registrato?
        <Link to={'/register'}>
           <span className='text-[#339a9a] hover:text-[#2e8b8b] tracking-wider font-bold'> Iscriviti</span> 
        </Link>
      </div>
    </div>
  )
